...
ControlPanel::ControlPanel(QWidget* parent) : QWidget(parent) {
  ...
  settings_button = make_button(":/icons/settings.svg", tr("Settings"), this);
  ...
  connect(settings_button, &QPushButton::clicked, this, &ControlPanel::settings_requested);
  ...
  layout->addWidget(settings_button, 0, 5, 1, 1);
  layout->addWidget(trash_button,    0, 6, 1, 1);
  layout->addWidget(game_list_view,  1, 0, 4, 7);
